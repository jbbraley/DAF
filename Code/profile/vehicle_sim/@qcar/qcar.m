...
%% classdef qcar
% 
% https://www.mathworks.com/matlabcentral/fileexchange/35478-simulation-and-animation-of-a-quarter-car-automotive-suspension-model?focused=5221682&tab=function
% 
% author: John Braley
...
%% dependent methods
	methods 
        ...
        %% Construct linear state space model 
            Aqcar = [0 1 0 0;-self.kus/self.mus -self.c/self.mus self.k/self.mus self.c/self.mus;...
                0 -1 0 1; 0 self.c/self.ms -self.k/self.ms -self.c/self.ms];
            Bqcar = [-1 0 0 0]'; 
