classdef qcar_met < handle & classio
%% classdef qcar
...
%% object properties
	properties        
        profile         % elevation profile over which the model traverses (m);
        ...
        kus             % stiffness of tire (or first sprung mass) (N/m)
	...
	methods 
        ...
        %% Construct linear state space model 
            Aqcar = [0 0 0 1; 0 0 1 -1;...
                    0 -self.k/(self.ms) -self.c/(self.ms) self.c/(self.ms);...
                    -self.kus/(self.mus) self.k/(self.mus) self.c/(self.mus) -self.c/(self.mus)];
